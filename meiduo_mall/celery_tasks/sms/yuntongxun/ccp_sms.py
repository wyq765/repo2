...
_accountSid = '8a216da8737097090173745034240117'

# 说明：主账号Token，登陆云通讯网站后，可在控制台-应用中看到开发者主账号AUTH TOKEN
_accountToken = 'debd91d0fc804840a8bc98e662c8cd49'

# 请使用管理控制台首页的APPID或自己创建应用的APPID
_appId = '8a216da873709709017374503530011e'
...
if __name__ == '__main__':
    ...
    # 单例类发送短信验证码
    CCP().send_template_sms('15090386227', ['123456', 5], 1)
